...
android {
    ...
    defaultConfig {
        ...
        resValue("string", "app_version", "1.1.1")
    ...
    buildTypes {
        release {
            ...
            manifestPlaceholders["APP_VERSION"] = "1.1.1"
            manifestPlaceholders["APP_DESCRIPTION"] = "模拟银行应用"
            manifestPlaceholders["APP_AUTHOR"] = "Laeperis"
            
            // 输出文件名配置
            setProperty("archivesBaseName", "eBank-v1.1.1-${System.currentTimeMillis()}")
        }
        ...
        debug {
            ...
            // 调试版本输出文件名
                setProperty("archivesBaseName", "eBank-v1.1.1-debug-${System.currentTimeMillis()}")
        }
    }
    compileOptions {
